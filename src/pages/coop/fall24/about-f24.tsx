...
const AboutF24 = () => {
  return (
    <div className="coop__text w-full h-full flex flex-col items-center justify-start px-4 md:px-20">
        ...
        <br/>
        <br/>
        The company&#39;s focus on advancing next-generation technologies ensures not only fast and dependable connectivity but also enables Canadian businesses to thrive on a global stage. Bell&#39;s commitment to innovation and adaptability is reflected in its role as a leader in telecommunications, continually shaping the future of communication while making a meaningful impact in communities nationwide. </p>
    
        {/* Images section */}
        <div className="s24Images flex justify-center gap-8 mt-8">
          <img src="/s24CoopImgs/about-bell1.jpg" alt="bellAbout1Img" className="w-[14rem] h-auto" />
          <img src="/s24CoopImgs/about-bell2.jpg" alt="bellAbout2Img" className="w-[14rem] h-auto" />
        </div>
