  ...
  return (
    <div className="coop__text w-full h-full flex flex-col items-center justify-start px-4 md:px-20">
      ...
      <p className={`coop__paragraph text-1xl text-center ${playfairDisplay.className} mt-4 leading-relaxed max-w-7xl p-4`}>
        ...
        <br />
        <br />
        As one of Canada&#39;s foremost telecommunications companies, Bell specializes in advanced communications services, including wireless, internet, and television. The company plays a critical role in fields like network engineering, cloud computing, cybersecurity, and digital platform development. Known for its innovation, Bell continues to build high-speed networks and digital solutions that connect millions of Canadians, shaping the future of communication across the country.
      </p>
      ...
      <div className="s24Images flex justify-center gap-8 mt-8">
        <div className="relative w-[14rem] h-[10rem]">
          <Image
            src="/s24CoopImgs/bell-about2.png"
            alt="Bell Canada service illustration 1"
            layout="fill"
            objectFit="contain"
            className="rounded"
            priority
        ...
        <div className="relative w-[14rem] h-[10rem]">
          <Image
            src="/s24CoopImgs/bell-about3.png"
            alt="Bell Canada service illustration 2"
            layout="fill"
            objectFit="contain"
            className="rounded"
            priority
        ...
        <div className="relative w-[14rem] h-[10rem]">
          <Image
            src="/s24CoopImgs/bell-about.webp"
            alt="Bell Canada main building"
            layout="fill"
            objectFit="contain"
            className="rounded"
            priority
