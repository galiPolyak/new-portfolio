  ...
  return (
    <div className="coop__text w-full h-full flex flex-col items-center justify-start px-4 md:px-20">
      ...
      <div className="s24Images flex gap-4 mt-8">
        <div className="relative w-[16rem] h-[12rem]">
          <Image
            src="/s24CoopImgs/bell-building.jpeg"
            alt="Bell building exterior"
            layout="fill"
            objectFit="contain"
            priority
          />
        ...
        <div className="relative w-[16rem] h-[12rem]">
          <Image
            src="/s24CoopImgs/bell-interior.jpeg"
            alt="Bell office interior"
            layout="fill"
            objectFit="contain"
            priority
          />
