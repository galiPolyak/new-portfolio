...
const IntroductionS24 = () => {
  return (
    <div className="coop__text w-full h-[calc(100vh-6rem)] flex flex-col items-center justify-start px-4 md:px-20">
        <h1 className={`coop__title mt-20 text-6xl text-[#004B87] ${playfairDisplay.className}`} style={{ lineHeight: '1.2' }}>
